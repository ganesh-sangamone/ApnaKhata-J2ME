...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String pid = "1209";   //product-id for ApnakhataBangali 
    ...
    public Activation() {
      /*try {
        ...
        t1 = new TextField("ডিলার আইডি", null, 50, TextField.NUMERIC);
        t2 = new TextField("পাসওয়ার্ড", null, 50, TextField.NUMERIC);
    ...
    public void authenticate() {
        ...
        DealerCode = Integer.parseInt(t1.getString().trim());
        Password = Integer.parseInt(t2.getString().trim());
        ...
        if (date1 == date || date2.equals(t2.getString())) {
            try {
                RecordStore.deleteRecordStore("Activation");
            } catch (RecordStoreException ex) {
                ex.printStackTrace();
            ...
            send_sms();
            Alert a1 = new Alert("সক্রিয়করণ", "অ্যাক্টিভেশন প্রক্রিয়া সফল হয়", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("সক্রিয়করণ", "সক্রিয়করণ ব্যর্থ. আপনার বিক্রেতার সাথে যোগাযোগ করুন", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t1.setString("");
            t2.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("সতর্কীকরণ","পণ্য ইতিমধ্যে সক্রিয় করা হয়, ApnaKhata ব্যবহার শুরু করুন", null, AlertType.INFO);
