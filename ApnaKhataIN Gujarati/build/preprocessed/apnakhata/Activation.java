...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String pid = "1210";   //product-id for ApnakhataGujarati
    ...
    public Activation() {
      /*try {
        ...
        t1 = new TextField("ડીલર આઈડી", null, 50, TextField.NUMERIC);
        t2 = new TextField("પાસવર્ડ", null, 50, TextField.NUMERIC);
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t2.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("આક્ટિવેશન", "આક્ટિવેશન કંઈપણ સફળ છે", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("આક્ટિવેશન", "સક્રિયકરણ નિષ્ફળ. તમારા ડીલર સંપર્ક કરો", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t1.setString("");
            t2.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("ચેતવણી","ઉત્પાદન પહેલેથી જ સક્રિય થયેલ છે, ApnaKhata ઉપયોગ શરૂ કરો", null, AlertType.INFO);
