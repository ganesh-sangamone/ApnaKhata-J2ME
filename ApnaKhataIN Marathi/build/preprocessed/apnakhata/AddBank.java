...
public class AddBank extends MIDlet implements CommandListener {
    ...
    public AddBank(){       
        ...
        if(check.equalsIgnoreCase("true")) {
            cg = new ChoiceGroup("कृपया आपली बॅंक निवडा", ChoiceGroup.MULTIPLE);           
            bankOperation();
            readRecords();
        }
        else {
            Alert a3;
            a3 = new Alert("चेतावनी", "उत्पाद सक्रिय करा", null, AlertType.WARNING);
    ...
    public void save() {
        ...
        try {
            ...
            if(cg.getSelectedFlags(picks) > 0){            
                ...
                a = new Alert("चेतावनी", "कमीत कमी एक बॅंक निवडा".trim(), null, AlertType.INFO);
                a.setTimeout(Alert.FOREVER);
                display.setCurrent(a);
          }
          os.close();
