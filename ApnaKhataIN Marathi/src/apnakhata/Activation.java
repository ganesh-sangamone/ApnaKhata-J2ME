...
public class Activation extends MIDlet implements CommandListener {
    ...
    private static String t, pid="1202";
    ...
    public Activation() {
      /*try {
        ...
        form = new Form("डीलर एक्टिवेशन फॉर्म");
        form2 = new Form("Warning");
        t1 = new TextField("डीलर आईडी", null, 50, TextField.NUMERIC);
        t2 = new TextField("पासवर्ड", null, 50, TextField.NUMERIC);
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t2.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("एक्टिवेशन", "आक्टिवेशन प्रक्रिया यशस्वी झाली आहे", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("एक्टिवेशन", "सक्रियन अयशस्वी. आपल्या विक्रेता संपर्क साधा", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t1.setString("");
            t2.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("चेतावनी","उत्पादन आधीच सक्रिय, ApnaKhata वापरून प्रारंभ करा", null, AlertType.INFO);
