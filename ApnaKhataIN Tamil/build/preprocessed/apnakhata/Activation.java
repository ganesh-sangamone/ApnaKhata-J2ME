...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String t1 = "1204";   //product-id for ApnakhataTamil
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t3.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("செயல்படுத்தல்", "வாழ்த்துக்கள். செயல்படுத்தல் வெற்றிகரமான", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("செயல்படுத்தல்", "செயலாக்கம் தோல்வியுற்றது. உங்கள் வியாபாரி தொடர்பு கொள்ளவும்", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t2.setString("");
            t3.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("எச்சரிக்கை", "தயாரிப்பு ஏற்கனவே செயல்படுத்தப்படுகிறது, ApnaKhata பயன்படுத்தி தொடங்க தயவு செய்து", null, AlertType.INFO);
