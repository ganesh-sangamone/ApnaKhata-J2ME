...
public class AddBank extends MIDlet implements CommandListener {
    ...
    public AddBank(){       
        ...
        if(check.equalsIgnoreCase("true")) {
            cg = new ChoiceGroup("మీ బ్యాంకు ఎంచుకోండి", ChoiceGroup.MULTIPLE);           
            bankOperation();
            readRecords();
        }
        else {
            Alert a3;
            a3 = new Alert("హెచ్చరిక", "ఉత్పత్తి అమలు", null, AlertType.WARNING);
    ...
    public void save() {
        ...
        try {
            ...
            if(cg.getSelectedFlags(picks) > 0){            
                ...
                alr = new Alert("సమాచారం","నిల్వ డేటా", null, AlertType.INFO);
                alr.setTimeout(1000);
                ...
                a = new Alert("హెచ్చరిక", "కనీసం ఒక బ్యాంక్ తనిఖీ చేయండి".trim(), null, AlertType.INFO);
                a.setTimeout(Alert.FOREVER);
                display.setCurrent(a);
          }
          os.close();
