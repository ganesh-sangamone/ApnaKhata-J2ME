...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String t1 = "1205";   //product-id for ApnakhataTelugu
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t3.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("యాక్టివేషన్", "శుభాకాంక్షలు. విజయవంతంగా అమలు", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("యాక్టివేషన్", "సక్రియం చేయడం విఫలమైంది. మీ డీలర్ సంప్రదించండి", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t2.setString("");
            t3.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("హెచ్చరిక", "ఉత్పత్తి ఇప్పటికే సక్రియం, ApnaKhata ఉపయోగించి ప్రారంభించండి", null, AlertType.INFO);
