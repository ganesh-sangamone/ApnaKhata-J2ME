...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String t1 = "1207";   //product-id for ApnakhataPunjabi
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t3.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("ਸਰਗਰਮ", "ਗ੍ਰੀਟਿੰਗ. ਸਫਲ ਲਾਗੂ ਕਰਨ", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("ਸਰਗਰਮ", "ਐਕਟੀਵੇਸ਼ਨ ਫੇਲ੍ਹ ਹੈ. ਤੁਹਾਡੇ ਡੀਲਰ ਨਾਲ ਸੰਪਰਕ ਕਰੋ ਜੀ", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t2.setString("");
            t3.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("ਚੇਤਾਵਨੀ", "ਉਤਪਾਦ ਹੀ ਸਰਗਰਮ ਹੈ, ApnaKhata ਵਰਤ ਸ਼ੁਰੂ ਕਰਨ, ਕਿਰਪਾ ਕਰਕੇ", null, AlertType.INFO);
