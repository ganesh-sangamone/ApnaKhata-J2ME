 ...
 * @author Ganesh
 */
public class ApnakhataINHindi extends MIDlet implements CommandListener, ItemStateListener {
    ...
    public ApnakhataINHindi(){    
        ...
        if(check.equalsIgnoreCase("true")) {  //wait
            i = readRecords();            
            cg = new ChoiceGroup("आपके बैंक का चयन करें", ChoiceGroup.EXCLUSIVE);           
            if(i == 1) {
                bankOperation();
            }
            else {
                 aa = new Alert("चेतावनी","AddBank में जाओ और अपने बैंकों का चयन करें", null, AlertType.ALARM);
            ...
            Alert a3;
            a3 = new Alert("चेतावनी", "ApnaKhata सक्रिय करें", null, AlertType.WARNING);
   ...
   public String file(String filename){
     ...
     public class GUI implements CommandListener, ItemStateListener {      
        private ApnakhataINHindi parent;
        ...
        public GUI(ApnakhataINHindi parent, String message, String bname) {   
        
        back1 = new Command ("Back", Command.BACK, 1);
        submit1 = new Command("Submit", Command.SCREEN, 1);
        send1 = new Command("Send", Command.OK, 1);
        radioButton = new ChoiceGroup("किसी भी विकल्प का चयन करें",Choice.EXCLUSIVE);
