...
public class Activation extends MIDlet implements CommandListener {
    ...
    private final String pid = "1201";   //product-id for ApnakhataHindi
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t2.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("एक्टिवेशन", "आक्टिवेशन प्रोसेस सफल हो गयी हे", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("एक्टिवेशन", "सक्रियण विफल. अपने डीलर से संपर्क करें", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t1.setString("");
            t2.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("चेतावनी","उत्पाद पहले से ही सक्रिय है, ApnaKhata का उपयोग शुरू कृपया", null, AlertType.INFO);
