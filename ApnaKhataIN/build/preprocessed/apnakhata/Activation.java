...
public class Activation extends MIDlet implements CommandListener {
    ...
    private static String t, t1 = "1200";
    ...
    public Activation() {
      /*try {
        ...
        form = new Form("Dealer Activation Form");
    ...
    public void authenticate() {
        ...
        if (date1 == date || date2.equals(t3.getString())) {
            ...
            send_sms();
            Alert a1 = new Alert("ACTIVATION", "Congrats. Activation Successful", null, AlertType.INFO);
            ...
            Alert a1 = new Alert("ACTIVATION", "Activation Failed. Please contact your dealer", null, AlertType.INFO);
            a1.setTimeout(Alert.FOREVER);
            Display.getDisplay(this).setCurrent(a1, form);
            t2.setString("");
            t3.setString("");
    ...
    public void commandAction(Command c, Displayable d) {
        if (c == activate) {
            ...
            if (check.equalsIgnoreCase("false")) {
                ...
                Alert a;
                a = new Alert("Warning", "product is already activated, please start using ApnaKhata", null, AlertType.INFO);
