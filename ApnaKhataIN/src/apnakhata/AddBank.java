...
public class AddBank extends MIDlet implements CommandListener {
    ...
    public AddBank(){       
        ...
        if(check.equalsIgnoreCase("true")) {
            cg = new ChoiceGroup("Select your Bank", ChoiceGroup.MULTIPLE);           
            bankOperation();
            readRecords();
        }
        else {
    ...
    public void save() {
        ...
        try {
            ...
            if(cg.getSelectedFlags(picks) > 0){            
                ...
                alr = new Alert("Info","Data Saved", null, AlertType.INFO);
                alr.setTimeout(1000);
                ...
                a = new Alert("Warning", "Please check at least one Bank", null, AlertType.INFO);
                a.setTimeout(Alert.FOREVER);
                display.setCurrent(a);
          }
          os.close();
